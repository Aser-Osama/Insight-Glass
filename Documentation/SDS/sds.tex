...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Images/class_II.png}
    \caption{Classes of Insight Glass}
\end{figure}
\newpage
In the following use case diagram, we depict the main functionalities of Insight Glass.
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Images/use_case.PNG}
    \caption{Use case diagram of Insight Glass}
\end{figure}
The following is a context diagram that represents the relationship between
data and business processes visually.
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{Images/context_diagram.png}
